...
## DIRECTORY OR FILES
The following are the files used in the model; Readme, Agentframework, drunk.plan.txt and independent(model).To have access to the files in the repository,simply click https://github.com/gy19ynk/INDEPENDENT
